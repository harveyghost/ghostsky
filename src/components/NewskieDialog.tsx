  ...
  const getJoinMessage = () => {
    ...
    if (isMe) {
      if (profile.joinedViaStarterPack) {
        return _(
          msg`You joined Ghostsky using a starter pack ${timeAgoString} ago`,
        )
      } else {
        return _(msg`You joined Ghostsky ${timeAgoString} ago`)
      }
    } else {
      if (profile.joinedViaStarterPack) {
        return _(
          msg`${profileName} joined Ghostsky using a starter pack ${timeAgoString} ago`,
        )
      } else {
        return _(msg`${profileName} joined Ghostsky ${timeAgoString} ago`)
      }
    }
  }
