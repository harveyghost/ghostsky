...
// GHOST: was a Zendesk support-ticket form on Bluesky's real help desk
export function FEEDBACK_FORM_URL(_args: {
  email?: string
  handle?: string
}): string {
...
// GHOST: tos/privacy were Bluesky's real policy pages on bsky.social.
// community/communityDeprecated left pointed at Bluesky's actual moderation
// guidelines since this fork still runs on the real AT Protocol network and
// is subject to the same real moderation/community rules — that's accurate
