          ...
          <ErrorBoundary>
            ...
            <View
              ...
              <Button
                ...
                accessibilityHint={_(
                  msg`Opens flow to create a new Ghostsky account`,
                )}
                size="large"
                variant="solid"
                color="primary">
              ...
              <Button
                ...
                label={_(msg`Sign in`)}
                accessibilityHint={_(
                  msg`Opens flow to sign in to your existing Ghostsky account`,
                )}
                size="large"
                variant="solid"
                color="secondary">
...
function Footer() {
  ...
  return (
    <View
      ...
      <InlineLinkText
        label={_(msg`Learn more about Ghostsky`)}
        to="https://bsky.social">
        <Trans>Business</Trans>
      </InlineLinkText>
      <InlineLinkText
        label={_(msg`Read the Ghostsky blog`)}
        to="https://bsky.social/about/blog">
        <Trans>Blog</Trans>
      </InlineLinkText>
      <InlineLinkText
        label={_(msg`See jobs at Ghostsky`)}
        to="https://bsky.social/about/join">
        <Trans comment="Link to a page with job openings at Ghostsky">
          Jobs
        </Trans>
      </InlineLinkText>
