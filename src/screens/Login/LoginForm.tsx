...
export const LoginForm = ({
  ...
  const [isUsingAccountPassword, setIsUsingAccountPassword] = useState(false)
  ...
  return (
    <FormContainer testID="loginForm" titleText={<Trans>Sign in</Trans>}>
      ...
      <View>
        ...
        <TextField.Root isInvalid={errorField === 'password'}>
          ...
          <TextField.Input
            ...
            onChangeText={v => {
              ...
              setIsUsingAccountPassword(!!v && !isAppPassword)
            }}
        ...
        {isUsingAccountPassword && !isAuthFactorTokenNeeded && (
          <Admonition.Outer type="warning" style={[a.mt_sm]}>
            <Admonition.Row>
              <Admonition.Icon />
              <Admonition.Content>
                <Admonition.Text>
                  <Trans>
                    For your security, use an{' '}
                    <InlineLinkText
    ...
    <Button
      ...
      <ButtonText
        ...
        {state.status === 'detected' || state.status === 'overridden' ? (
          ...
          <Trans>Hosting provider: Ghostsky</Trans>
        ) : (
