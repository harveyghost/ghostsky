...
module.exports = function (_config) {
  ...
  return {
    expo: {
      version: VERSION,
      // GHOST: name/slug/scheme/primaryColor rebranded. Left iOS/Android
      // bundleIdentifier, EAS projectId, Sentry org, and entitlements
      // untouched below - they're meaningless for a local `yarn web` build
      // and only matter if you set up your own Apple/Google/Expo developer
      // accounts for a real native build.
      name: 'Ghostsky',
      slug: 'ghostsky',
      scheme: 'ghostsky',
      owner: 'blueskysocial',
