      ...
      <View style={[a.relative, a.gap_md, a.w_full]}>
        ...
        {fixedOption === BSKY_SERVICE && isFirstTimeUser && (
          <View role="tabpanel">
            <Admonition type="tip">
              <Trans>
                Ghostsky is an open network where you can choose your own
                provider. If you're new here, we recommend sticking with the
                default Ghostsky Social option.
              </Trans>
            </Admonition>
          </View>
        )}
        ...
        <View style={[a.py_xs]}>
          <Text
            ...
            {isFirstTimeUser ? (
              ...
              <Trans>
                Ghostsky is an open network where you can choose your hosting
