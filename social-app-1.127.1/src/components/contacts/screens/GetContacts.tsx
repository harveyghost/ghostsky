    ...
    <View style={[a.h_full]}>
      ...
      <View
        ...
        <Text style={[a.text_sm, a.pb_xs]}>
          <Trans>
            I consent to Ghostsky using my contacts for mutual friend discovery
...
function showPermissionDeniedAlert() {
  Alert.alert(
    ...
    t`You'll need to go to the System Settings for Ghostsky and give permission if you want to use this feature.`,
    [
      {
        text: t`OK`,
        style: 'default',
