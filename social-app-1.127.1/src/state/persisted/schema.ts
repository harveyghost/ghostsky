...
export const defaults: Schema = {
  colorMode: 'dark', // GHOST: was 'system' — force dark (Mocha) as the default for everyone, not just as an option
  darkTheme: 'dark', // GHOST: was 'dim' — 'dark' is the fully-recolored Mocha variant
  session: {
    accounts: [],
