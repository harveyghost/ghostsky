...
init({
  // GHOST: explicitly disabled, not just relying on an absent DSN.
  // Bluesky's fork guidelines specifically ask forks to replace their
  // error-collection system rather than silently keep sending data to
  // theirs — this fork just turns it off outright.
  enabled: false,
